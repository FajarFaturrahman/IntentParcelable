    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(move_with_data.EXTRA_NAME, "Fajar Faturrahman");
            ...
            case R.id.btn_move_activty_object:
                ...
                mPerson.setName("Fajar Faturrahman");
                mPerson.setAge(17);
                mPerson.setEmail("fajarfaturrahman06@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "088802333501";
